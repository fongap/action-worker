...
![最近更新](https://img.shields.io/badge/最近更新-2026--03--19-007acc?logo=git&logoColor=white&color=007acc)
...
| 类型 | 变量名 | 用途 | 权限要求 |
|------|--------|------|----------|
| **机密变量** | `GH_SOURCE_VAULT_REPO` | 私密资产仓路径（格式：owner/repo） | - |
| **机密变量** | `GH_SOURCE_VAULT_PAT` | 私密资产仓访问令牌 | `repo` 读取权限 |
